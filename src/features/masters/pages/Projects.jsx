  ...
  return (
    <div className="max-w-[1200px] mx-auto">
      ...
      <div className="space-y-3">
        {PROJECTS.map((p) => (
          <div key={p.id} className="bg-surface-container-lowest border border-border rounded-lg p-5 shadow-sm hover:shadow-lg hover:-translate-y-0.5 hover:border-primary transition-all duration-200">
